...
11. Docker-compose
    ...
    - Контейнер tgbot, где хранится вся бизнес-логика телеграм бота
    - Контейнер backend - API для авторизации пользователей
    - Контейнер migrations для орагнизации базы данных(создание таблиц, индексов и наполнение данными)
    - Контейнер redis содержащий в себе сервис Redis полученный с dockerhub
    - Контейнер psql_db содержащий в себе сервис PostgreSQL полученный с dockerhub
