...
@pytest.mark.parametrize("tg_login, res", [("@test", 1)])
def test_fetch_user_by_tg_login(
    psql_connect, setup_users_table, tg_login, res
):
    setup_users_table
...
@pytest.mark.parametrize("id, res", [("", None)])
