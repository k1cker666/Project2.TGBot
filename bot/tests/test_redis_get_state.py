...
def test_get_state(create_user_state_obj: UserStateProcessor, x, y, res):
        user_state = create_user_state_obj
...
def test_get_state_nonetype(create_user_state_obj: UserStateProcessor, x, res):
    user_state = create_user_state_obj
    assert user_state.get_state(x) == res